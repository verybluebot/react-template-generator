...
function getReduxCoreDirs(reduxCoreDirectory) {
    // TODO: change this to user directory.. if does not exist create one...
...
function getReactComponentDirs(name, directory, native, redux) {
    ...
    if (!native) {
        // TODO: usecase for 'module.scss' implementation and for non 'module'
    ...
    // TODO: TS for future implementation
